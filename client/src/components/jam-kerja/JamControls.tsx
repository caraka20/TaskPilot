...
export default function JamControls({
  ...
  // doStart membaca state sesi terbaru; listener didaftarkan ulang hanya saat status sesi berubah.
  // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [mode, status, activeSessionId]);
      ...
      <div className="rounded-[22px] p-[1.5px] bg-gradient-to-r from-white/10 to-white/10">
        <div className="rounded-[20px] border border-default-200/70 bg-background/90 backdrop-blur-sm">
          <div className="flex flex-col gap-4 p-4 sm:p-5">
            ...
            <div className="flex flex-col gap-2 text-xs text-foreground-400 sm:flex-row sm:items-center sm:justify-between">
              <span>
                {mode === "user"
