    ...
    >
      <div className="flex items-center justify-between gap-3 flex-wrap">
        ...
        <div className="flex w-full min-w-0 flex-col gap-2 sm:w-auto sm:flex-row sm:items-center">
          ...
          <div className="flex max-w-full items-center gap-1 overflow-x-auto pb-1 touch-pan-x sm:pb-0">
            {SESSIONS.map((s) => {
              const active = sesi === s.sesi;
              const baseBtn =
                "min-h-10 shrink-0 rounded-lg px-3 py-1.5 text-[12px] font-medium transition ring-1 ring-inset sm:min-h-0 sm:px-2.5";
              const inactiveCls =
        ...
        <div className="grid w-full grid-cols-2 gap-2 sm:flex sm:w-auto sm:flex-wrap sm:items-center">
          <Tooltip placement="bottom" offset={6} content="Set semua Diskusi di sesi terpilih menjadi SELESAI">
            <Button
              size="sm"
              className="min-h-10 bg-sky-600 text-white disabled:opacity-60 sm:min-h-0"
          ...
          <Tooltip placement="bottom" offset={6} content="Set semua Absen di sesi terpilih menjadi SELESAI">
            <Button
              size="sm"
              className="min-h-10 bg-emerald-600 text-white sm:min-h-0"
              startContent={<CheckSquare className="h-4 w-4" />}
          ...
          <Tooltip placement="bottom" offset={6} content="Set semua Tugas di sesi terpilih menjadi SELESAI">
            <span>
              <Button
                size="sm"
                className="min-h-10 bg-violet-600 text-white disabled:opacity-60 sm:min-h-0"
                startContent={<CheckSquare className="h-4 w-4" />}
          ...
          <div className="hidden h-6 w-px bg-default-200 mx-1 sm:block" />

          <Tooltip placement="bottom" offset={6} content="Tandai COPAS Diskusi untuk semua course di sesi terpilih (draft)">
            <Button
              size="sm"
              variant="flat"
              className="min-h-10 bg-default-100 disabled:opacity-60 dark:bg-content2 sm:min-h-0"
          ...
          <Tooltip placement="bottom" offset={6} content="Tandai COPAS Tugas untuk semua course di sesi terpilih (draft)">
            <span>
              <Button
                size="sm"
                variant="flat"
                className="min-h-10 bg-default-100 dark:bg-content2 disabled:opacity-60 sm:min-h-0"
                startContent={<ClipboardCheck className="h-4 w-4" />}
          ...
          >
            <Button
              size="sm"
              className="min-h-10 bg-green-700 text-white sm:min-h-0"
          ...
          <Chip
            size="sm"
            variant="flat"
            className="col-span-2 justify-center bg-default-100 dark:bg-content2 dark:text-foreground-600 sm:col-span-1"
